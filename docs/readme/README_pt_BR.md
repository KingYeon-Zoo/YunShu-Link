...
· <a href="https://github.com/KingYeon-Zoo/YunShu-Link/issues">Reportar Problemas</a>
· <a href="../../README.md#%E9%83%A8%E7%BD%B2%E6%96%87%E6%A1%A3">Documentação de Implantação</a>
· <a href="https://github.com/KingYeon-Zoo/YunShu-Link/releases">Notas de Lançamento</a>
</p>
...
|:---:|:---|
| Arquitetura Principal | Baseado em [gateway MQTT+UDP](https://github.com/KingYeon-Zoo/YunShu-Link/blob/main/docs/mqtt-gateway-integration.md), servidores WebSocket e HTTP, fornece sistema completo de gerenciamento de console e autenticação |
