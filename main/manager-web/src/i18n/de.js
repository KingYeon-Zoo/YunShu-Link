export default {
  ...
  'login.brandName': 'YunShu',
  'login.brandTitle': 'AI Voice Hardware Management Platform',
  'login.brandSlogan': 'Connect devices, configure agents, manage models — all in one sentence.',
  ...
  'user.logout': 'Logout',
  'user.logoutConfirm': 'Are you sure you want to logout?',
  ...
  'sidebar.deviceManagement': 'Devices',
  ...
  'sidebar.users': 'Users',
  'sidebar.ota': 'OTA',
  'sidebar.dict': 'Dictionary',
  'sidebar.provider': 'Providers',
  'sidebar.roleTemplate': 'Role Templates',
  'sidebar.replacement': 'Replacement Words',
  'sidebar.server': 'Server',
  'sidebar.feature': 'Features',

  // Breadcrumb
  'breadcrumb.home': 'Home',
  'breadcrumb.dashboard': 'Dashboard',
  'breadcrumb.roleConfig': 'Role Config',
  'breadcrumb.deviceManagement': 'Devices',
  'breadcrumb.userManagement': 'Users',
  'breadcrumb.modelConfig': 'Model Config',
  'breadcrumb.knowledgeBase': 'Knowledge Base',
  'breadcrumb.server': 'Server',
  'breadcrumb.ota': 'OTA',
  'breadcrumb.voiceResource': 'Voice Resources',
  'breadcrumb.voiceClone': 'Voice Clone',
  'breadcrumb.dict': 'Dictionary',
  'breadcrumb.provider': 'Providers',
  'breadcrumb.roleTemplate': 'Role Templates',
  'breadcrumb.templateQuickConfig': 'Quick Config',
  'breadcrumb.feature': 'Features',
  'breadcrumb.replacement': 'Replacement Words',
  'breadcrumb.addressBook': 'Address Book',
  'breadcrumb.voicePrint': 'Voice Print',
  'breadcrumb.params': 'Parameters',

  // Home page text
  'home.addAgent': 'Agent hinzufügen',
  'home.myAgents': 'My Agents',
  'home.statAgents': 'Agents',
  'home.statDevices': 'Devices',
  'home.statOnline': 'Online',
  'home.statModels': 'Models',
  'home.statusSummary': '{online} devices online today, {active} agents active',
  'home.emptyAgentTip': 'No agents yet, click to add',
  ...
  'breadcrumb.dashboard': 'Dashboard',
  'breadcrumb.roleConfig': 'Rollenkonfiguration',
  'breadcrumb.deviceManagement': 'Geräteverwaltung',
  'breadcrumb.userManagement': 'Benutzerverwaltung',
  'breadcrumb.modelConfig': 'Modellkonfiguration',
  'breadcrumb.knowledgeBase': 'Wissensdatenbank',
  'breadcrumb.server': 'Serververwaltung',
  'breadcrumb.ota': 'OTA-Verwaltung',
  'breadcrumb.voiceResource': 'Sprachressourcen',
  'breadcrumb.voiceClone': 'Sprachklonverwaltung',
  'breadcrumb.dict': 'Wörterbuchverwaltung',
  'breadcrumb.provider': 'Anbieterverwaltung',
  'breadcrumb.roleTemplate': 'Rollenvorlagenverwaltung',
  'breadcrumb.templateQuickConfig': 'Schnellvorlagenkonfiguration',
  'breadcrumb.feature': 'Funktionsverwaltung',
  'breadcrumb.replacement': 'Ersatzwortverwaltung',
  'breadcrumb.addressBook': 'Adressbuchverwaltung',
  'breadcrumb.voicePrint': 'Sprachdruck',
  'breadcrumb.params': 'Parameterverwaltung',
  'user.language': 'Sprache wechseln',
