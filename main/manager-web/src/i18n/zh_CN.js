export default {
  ...
  'login.brandName': '云枢',
  'login.brandTitle': '智能语音硬件管理平台',
  'login.brandSlogan': '连接设备、配置智能体、管理模型，一句话掌控全局。',
  ...
  'sidebar.replacement': '替换词',
  'sidebar.server': '服务端管理',
  ...
  'breadcrumb.deviceManagement': '设备管理',
  'breadcrumb.userManagement': '用户管理',
  'breadcrumb.modelConfig': '模型配置',
  'breadcrumb.knowledgeBase': '知识库',
  'breadcrumb.server': '服务端管理',
  'breadcrumb.ota': 'OTA 管理',
  'breadcrumb.voiceResource': '音色资源',
  ...
  'breadcrumb.replacement': '替换词管理',
  'breadcrumb.addressBook': '通讯录',
  'breadcrumb.voicePrint': '声纹管理',
  'breadcrumb.params': '参数管理',

  // 首页文本
  'home.addAgent': '添加智能体',
  'home.myAgents': '我的智能体',
  'home.statAgents': '智能体数量',
  'home.statDevices': '设备数量',
  'home.statOnline': '在线设备',
  'home.statModels': '模型配置',
  'home.statusSummary': '今日 {online} 台设备在线，{active} 个智能体活跃',
  'home.emptyAgentTip': '暂无智能体，点击添加',
  'home.greeting': '你好小智',
