export default {
  ...
  'login.brandName': '雲樞',
  'login.brandTitle': '智能語音硬件管理平台',
  'login.brandSlogan': '連接設備、配置智能體、管理模型，一句話掌控全局。',
  ...
  'sidebar.addressBook': '通訊錄',
  'sidebar.system': '系統管理',
  'sidebar.params': '參數管理',
  'sidebar.users': '用戶管理',
  'sidebar.ota': 'OTA',
  'sidebar.dict': '字典管理',
  'sidebar.provider': '提供者管理',
  'sidebar.roleTemplate': '角色模板',
  'sidebar.replacement': '替換詞',
  'sidebar.server': '服務端管理',
  'sidebar.feature': '功能配置',

  // 麵包屑
  'breadcrumb.home': '首頁',
  'breadcrumb.dashboard': '儀表盤',
  'breadcrumb.roleConfig': '角色配置',
  'breadcrumb.deviceManagement': '設備管理',
  'breadcrumb.userManagement': '用戶管理',
  'breadcrumb.modelConfig': '模型配置',
  'breadcrumb.knowledgeBase': '知識庫',
  'breadcrumb.server': '服務端管理',
  'breadcrumb.ota': 'OTA 管理',
  'breadcrumb.voiceResource': '音色資源',
  'breadcrumb.voiceClone': '音色克隆',
  'breadcrumb.dict': '字典管理',
  'breadcrumb.provider': '提供者管理',
  'breadcrumb.roleTemplate': '角色模板',
  'breadcrumb.templateQuickConfig': '快速配置',
  'breadcrumb.feature': '功能配置',
  'breadcrumb.replacement': '替換詞管理',
  'breadcrumb.addressBook': '通訊錄',
  'breadcrumb.voicePrint': '聲紋管理',
  'breadcrumb.params': '參數管理',

  // 首頁文本
  'home.addAgent': '添加智能體',
  'home.myAgents': '我的智能體',
  'home.statAgents': '智能體數量',
  'home.statDevices': '設備數量',
  'home.statOnline': '在線設備',
  'home.statModels': '模型配置',
  'home.statusSummary': '今日 {online} 台設備在線，{active} 個智能體活躍',
  'home.emptyAgentTip': '暫無智能體，點擊添加',
  'home.greeting': '你好小智',
  ...
  'breadcrumb.userManagement': '用戶管理',
  'breadcrumb.modelConfig': '模型配置',
  'breadcrumb.knowledgeBase': '知識庫管理',
  'breadcrumb.server': '服務端管理',
  'breadcrumb.ota': 'OTA管理',
  'breadcrumb.voiceResource': '音色資源開通',
  'breadcrumb.voiceClone': '音色克隆管理',
  'breadcrumb.dict': '字典管理',
  'breadcrumb.provider': '供應商管理',
  'breadcrumb.roleTemplate': '角色模板管理',
  'breadcrumb.templateQuickConfig': '模板快速配置',
  'breadcrumb.feature': '功能配置',
  'breadcrumb.replacement': '替換詞管理',
  'breadcrumb.addressBook': '通訊錄管理',
  'breadcrumb.voicePrint': '聲紋管理',
  'breadcrumb.params': '參數管理',
  'user.language': '切換語言',
  'user.changePassword': '修改密碼',
